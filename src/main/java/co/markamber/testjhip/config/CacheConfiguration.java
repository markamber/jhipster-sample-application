package co.markamber.testjhip.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, co.markamber.testjhip.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, co.markamber.testjhip.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
/**
 * REST controller for managing {@link co.markamber.testjhip.domain.Manufacture}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ManufactureResource {
    ...
    public ResponseEntity<Manufacture> updateManufacture(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, manufacture.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Manufacture> partialUpdateManufacture(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, manufacture.getId().toString())
        );
    }

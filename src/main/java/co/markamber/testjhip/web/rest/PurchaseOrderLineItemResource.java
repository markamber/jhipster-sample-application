...
import co.markamber.testjhip.repository.PurchaseOrderLineItemRepository;
...
/**
 * REST controller for managing {@link co.markamber.testjhip.domain.PurchaseOrderLineItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PurchaseOrderLineItemResource {
    ...
    public ResponseEntity<PurchaseOrderLineItem> updatePurchaseOrderLineItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, purchaseOrderLineItem.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<PurchaseOrderLineItem> partialUpdatePurchaseOrderLineItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, purchaseOrderLineItem.getId().toString())
        );
    }

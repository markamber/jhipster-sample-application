...
import co.markamber.testjhip.repository.ReceivedItemRepository;
...
/**
 * REST controller for managing {@link co.markamber.testjhip.domain.ReceivedItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReceivedItemResource {
    ...
    public ResponseEntity<ReceivedItem> updateReceivedItem(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, receivedItem.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ReceivedItem> partialUpdateReceivedItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, receivedItem.getId().toString())
        );
    }

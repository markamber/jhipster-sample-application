...
public class ReceivedItem implements Serializable {
    ...
    public ReceivedItem tracked(Boolean tracked) {
    ...
    public ReceivedItem forInventory(Boolean forInventory) {
        this.setForInventory(forInventory);
        return this;
    }
    ...
    public ReceivedItem bundleQuantity(Long bundleQuantity) {

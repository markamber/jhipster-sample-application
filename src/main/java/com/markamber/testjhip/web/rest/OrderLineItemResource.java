...
/**
 * REST controller for managing {@link com.markamber.testjhip.domain.OrderLineItem}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class OrderLineItemResource {
    ...
    public ResponseEntity<OrderLineItem> partialUpdateOrderLineItem(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, orderLineItem.getId().toString())
        );
    }

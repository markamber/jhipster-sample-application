...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MANUFACTURE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MANUFACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MANUFACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MANUFACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MANUFACTURE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MANUFACTURE actions', async () => {
      const expectedActions = [
        {

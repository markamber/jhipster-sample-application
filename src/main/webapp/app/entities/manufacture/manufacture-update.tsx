  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.manufacture.home.createOrEditLabel" data-cy="ManufactureCreateUpdateHeading">
            Create or edit a Manufacture
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? <ValidatedField name="id" required readOnly id="manufacture-id" label="ID" validate={{ required: true }} /> : null}
              <ValidatedField label="Name" id="manufacture-name" name="name" data-cy="name" type="text" />

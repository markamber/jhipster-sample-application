...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERLINEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_ORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ORDERLINEITEM actions', async () => {
      const expectedActions = [
        {

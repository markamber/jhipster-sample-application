        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Model Name" id="product-modelName" name="modelName" data-cy="modelName" type="text" />
              <ValidatedField id="product-manufacture" name="manufacture" data-cy="manufacture" label="Manufacture" type="select">
                <option value="" key="0" />
                {manufactures

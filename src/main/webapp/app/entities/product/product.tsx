      ...
      <h2 id="product-heading" data-cy="ProductHeading">
        ...
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            ...
            <Translate contentKey="myApp.product.home.refreshListLabel">Refresh List</Translate>
          </Button>
        ...
        {productList && productList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="myApp.product.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.product.modelName">Model Name</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.product.type">Type</Translate>
                </th>
                <th>
                  <Translate contentKey="myApp.product.manufacture">Manufacture</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`myApp.ItemType.${product.type}`} />
                  </td>
                  <td>{product.manufacture ? <Link to={`/manufacture/${product.manufacture.id}`}>{product.manufacture.id}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.product.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>

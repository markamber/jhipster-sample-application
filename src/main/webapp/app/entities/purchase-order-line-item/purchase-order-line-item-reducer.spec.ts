...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './purchase-order-line-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASEORDERLINEITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_PURCHASEORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PURCHASEORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PURCHASEORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASEORDERLINEITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PURCHASEORDERLINEITEM actions', async () => {
      const expectedActions = [
        {

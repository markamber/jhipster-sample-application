  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2
            id="jhipsterSampleApplicationApp.purchaseOrderLineItem.home.createOrEditLabel"
            data-cy="PurchaseOrderLineItemCreateUpdateHeading"
          >
            Create or edit a PurchaseOrderLineItem
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField name="id" required readOnly id="purchase-order-line-item-id" label="ID" validate={{ required: true }} />
              ) : null}
              <ValidatedField label="Note" id="purchase-order-line-item-note" name="note" data-cy="note" type="text" />
              <ValidatedField
                ...
                type="date"
              />
              <ValidatedField id="purchase-order-line-item-product" name="product" data-cy="product" label="Product" type="select">
                <option value="" key="0" />
                {products

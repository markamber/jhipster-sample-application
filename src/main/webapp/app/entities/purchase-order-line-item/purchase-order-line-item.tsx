  ...
  return (
    <div>
      <h2 id="purchase-order-line-item-heading" data-cy="PurchaseOrderLineItemHeading">
        <Translate contentKey="myApp.purchaseOrderLineItem.home.title">Purchase Order Line Items</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="myApp.purchaseOrderLineItem.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="myApp.purchaseOrderLineItem.home.createLabel">Create new Purchase Order Line Item</Translate>
          </Link>
        </div>
      </h2>
        ...
        {purchaseOrderLineItemList && purchaseOrderLineItemList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="myApp.purchaseOrderLineItem.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="myApp.purchaseOrderLineItem.home.notFound">No Purchase Order Line Items found</Translate>
            </div>
          )
        )}
      </div>

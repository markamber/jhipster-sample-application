  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="myApp.purchaseOrder.home.createOrEditLabel" data-cy="PurchaseOrderCreateUpdateHeading">
            <Translate contentKey="myApp.purchaseOrder.home.createOrEditLabel">Create or edit a PurchaseOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('myApp.purchaseOrder.shipTo')}
                id="purchase-order-shipTo"
                name="shipTo"
                data-cy="shipTo"
                type="text"
              />
              <ValidatedField
                label={translate('myApp.purchaseOrder.notes')}
              ...
              />
              <ValidatedField
                label={translate('myApp.purchaseOrder.date')}
              ...
              />
              <ValidatedField
                id="purchase-order-poLineItems"
                name="poLineItems"
                data-cy="poLineItems"
                label={translate('myApp.purchaseOrder.poLineItems')}
                type="select"
              >
                <option value="" key="0" />

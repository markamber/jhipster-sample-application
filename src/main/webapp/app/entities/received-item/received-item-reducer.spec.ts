...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RECEIVEDITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_RECEIVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RECEIVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RECEIVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RECEIVEDITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RECEIVEDITEM actions', async () => {
      const expectedActions = [
        {

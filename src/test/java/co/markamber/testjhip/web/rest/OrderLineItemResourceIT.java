...
import static co.markamber.testjhip.web.rest.TestUtil.sameNumber;
...
import co.markamber.testjhip.domain.enumeration.LineItemType;
...
class OrderLineItemResourceIT {
    ...
    private static final LineItemType DEFAULT_TYPE = LineItemType.SALE_ITEM;
    private static final LineItemType UPDATED_TYPE = LineItemType.LABOR;
    ...
    void createOrderLineItem() throws Exception {
        ...
        assertThat(testOrderLineItem.getType()).isEqualTo(DEFAULT_TYPE);
    ...
    void putNewOrderLineItem() throws Exception {
        ...
        assertThat(testOrderLineItem.getType()).isEqualTo(UPDATED_TYPE);

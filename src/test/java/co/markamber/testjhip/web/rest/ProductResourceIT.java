...
import co.markamber.testjhip.domain.Product;
import co.markamber.testjhip.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().modelName(DEFAULT_MODEL_NAME);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().modelName(UPDATED_MODEL_NAME);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.modelName(UPDATED_MODEL_NAME);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.modelName(UPDATED_MODEL_NAME);

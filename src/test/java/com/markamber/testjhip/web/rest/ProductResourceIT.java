...
import com.markamber.testjhip.domain.Product;
import com.markamber.testjhip.domain.enumeration.ItemType;
import com.markamber.testjhip.repository.ProductRepository;
...
class ProductResourceIT {
    ...
    private static final ItemType DEFAULT_TYPE = ItemType.SALE_ITEM;
    private static final ItemType UPDATED_TYPE = ItemType.LABOR;
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().modelName(DEFAULT_MODEL_NAME).type(DEFAULT_TYPE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().modelName(UPDATED_MODEL_NAME).type(UPDATED_TYPE);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.modelName(UPDATED_MODEL_NAME).type(UPDATED_TYPE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.modelName(UPDATED_MODEL_NAME).type(UPDATED_TYPE);
